  ...
  <main id="main" class="main">
    ...
    <div class="card">
      ...
      <div class="card-header">
        ...
        <small>Jangan bagikan kata sandi kepada siapapun, demi keamanan data anda.</small>
      </div>
      ...
      <form>
          <div class="mb-3">
              ...
              <div class="input-group">
                <input type="password" class="form-control" id="newPassword" placeholder="Masukkan Password Baru Anda" aria-label="password">
            ...
            <div class="password-criteria" id="passwordCriteria">
              <span id="lengthCriteria" class="invalid">Minimal 8 karakter</span>
              <span id="uppercaseCriteria" class="invalid">Mengandung huruf besar</span>
              <span id="lowercaseCriteria" class="invalid">Mengandung huruf kecil</span>
            </div>
          
            <div class="mb-3">
              <label for="confirmPassword" class="form-label">Konfirmasi Kata Sandi Baru :</label>
              <div class="input-group">
                <input type="password" class="form-control" id="confirmPassword" placeholder="Konfirmasi Password Baru Anda" aria-label="password">
            ...
            <a href="/notif" class="btn custom-submit-btn">Verify</a>
          </div>          
        </form>
      </div>
    </div>
